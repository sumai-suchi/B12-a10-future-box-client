...
const EnhancedTopInstructor = () => {
  ...
  useEffect(() => {
    ...
    style.id = "instructor-swiper-styles";
    style.textContent = `
    ...
    if (!document.getElementById("instructor-swiper-styles")) {
      document.head.appendChild(style);
    }

    return () => {
      document.getElementById("instructor-swiper-styles")?.remove();
    };
  }, []);
  ...
  return (
    <section className="w-full bg-[#0B0C10] text-white py-24 px-6 lg:px-16 border-t border-slate-900/60 overflow-hidden antialiased relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[250px] bg-[#00F0FF]/5 blur-[120px] rounded-full" />
      </div>
